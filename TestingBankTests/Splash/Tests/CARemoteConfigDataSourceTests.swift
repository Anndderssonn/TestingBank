//
//  CARemoteConfigDataSourceTests.swift
//  TestingBankTests
//
...
@MainActor
final class CARemoteConfigDataSourceTests: XCTestCase {
    var mockNetworkClient: MockNetworkClient!
    var sut: CARemoteConfigDataSource!
    
    override func setUp() {
        super.setUp()
        mockNetworkClient = MockNetworkClient()
        sut = CARemoteConfigDataSource(client: mockNetworkClient)
    }
    ...
    func test_fetchConfig_usesCorrectURL() async throws {
        ...
        XCTAssertEqual(
            ...
            "https://api.ca.testingbank.com/v1/config"
        )
    }
