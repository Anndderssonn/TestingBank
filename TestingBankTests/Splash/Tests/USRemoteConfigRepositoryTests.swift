//
//  USRemoteConfigRepositoryTests.swift
//  TestingBankTests
//
...
@MainActor
final class USRemoteConfigRepositoryTests: XCTestCase {
    var mockDataSource: MockRemoteConfigDataSource!
    var sut: USRemoteConfigRepositoryImpl!
    
    override func setUp() {
        super.setUp()
        mockDataSource = MockRemoteConfigDataSource()
        sut = USRemoteConfigRepositoryImpl(dataSource: mockDataSource)
    }
